    ...
    >
      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Create Account</p>
        </div>
        ...
        >
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <Input
                className={`bg-transparent border ${errors.name ? "border-red-500" : "border-white/10"} focus:border-white/40 text-sm`}
            ...
            <div className="space-y-1">
              ...
              <Input
                className={`bg-transparent border ${errors.email ? "border-red-500" : "border-white/10"} focus:border-white/40 focus:ring-0 text-sm`}
            ...
            <div className="space-y-1">
              ...
              <Input
                className={`bg-transparent border ${errors.password ? "border-red-500" : "border-white/10"} focus:border-white/40 focus:ring-2 focus:ring-white/10 transition-all text-sm`}
                type="password"
                placeholder="••••••••"
                onChange={(e) => {
